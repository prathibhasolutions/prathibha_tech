...
SECRET_KEY = 'django-insecure-u)qe*x7ru)yv%)xrwq-l1hk@&=)qw)c7$)jzsl&-ryzh+=@mm6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['65.0.89.209', 'localhost', '127.0.0.1', 'tech.prathibhasolutions.com', 'www.tech.prathibhasolutions.com']
